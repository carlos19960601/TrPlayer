...
export const TranscribeConfigForm = (props: {
	onSubmit: (data: TranscribeConfigType) => void;
}) => {
	const { onSubmit } = props;
	const { models } = useContext(ModelProviderContext);

	const transcribeConfigFormSchema = z.object({
		language: z.string(),
		model: z.string(),
	});
	...
	const form = useForm<z.infer<typeof transcribeConfigFormSchema>>({
		resolver: zodResolver(transcribeConfigFormSchema),
		values: {
			language: "auto",
			model: "ggml-tiny",
		},
